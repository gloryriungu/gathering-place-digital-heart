    ...
    <footer className="bg-primary text-primary-foreground">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Church Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">Grace Community</h3>
            <p className="opacity-90 mb-4">
              A place where everyone belongs, grows in faith, and serves with purpose.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm opacity-90">
              <div>
                ...
                <div>9:00 AM - Traditional</div>
                <div>11:00 AM - Contemporary</div>
                <div>6:00 PM - Evening</div>
              </div>
              <div>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm opacity-90">
              ...
              <div><a href="#" className="hover:opacity-100">Sermons</a></div>
