...
import { Bell, Settings, User, LogOut, Video } from "lucide-react";
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div className="flex-1 min-w-0">
            <h1 className="text-xl sm:text-2xl lg:text-3xl font-black truncate">
              <span className="hidden sm:inline">MEDIA DEPARTMENT</span>
              <span className="sm:hidden">MEDIA DASHBOARD</span>
            </h1>
            <p className="text-gray-300 mt-1 text-sm sm:text-base truncate">
              <span className="hidden sm:inline">Content Management & Digital Media - TOT Int</span>
              <span className="sm:hidden">Digital Content</span>
            </p>
          </div>
