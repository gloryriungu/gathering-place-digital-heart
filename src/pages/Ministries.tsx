      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        ...
        <div className="container mx-auto px-4 py-24">
          <div className="text-center mb-12">
            ...
            <h1 className="text-5xl font-bold text-white mb-4">MINISTRIES</h1>
          ...
          <Card className="max-w-md mx-auto bg-white/95 backdrop-blur-sm">
            <CardHeader className="text-center">
              ...
              <CardDescription>
                To join a ministry, you need to be signed in. 
                This allows us to track your membership and keep you updated on ministry activities.
              </CardDescription>
            </CardHeader>
